...
namespace AlArz.Migrations
{
    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AL_BlockedUserTokens",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ToeknId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_BlockedUserTokens", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_ClaimTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ERPReference = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_CustomLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_LinkUsers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LookupTypeNumber = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_LookupTypes", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AL_OrganizationUnits",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_OrganizationUnits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AL_OrganizationUnits_AL_OrganizationUnits_ParentId",
                        column: x => x.ParentId,
                        principalTable: "AL_OrganizationUnits",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "AL_RegisterFireBases",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_RegisterFireBases", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_Roles", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AL_SecurityLogs",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_SecurityLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_Tenants", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AL_UserDelegations",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_UserDelegations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_Lookups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AL_Lookups_AL_LookupTypes_LookupTypeId",
                        column: x => x.LookupTypeId,
                        principalTable: "AL_LookupTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AL_Lookups_AL_Lookups_Parent",
                        column: x => x.Parent,
                        principalTable: "AL_Lookups",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AbpOrganizationUnitRoles_AL_OrganizationUnits_OrganizationUnitId",
                        column: x => x.OrganizationUnitId,
                        principalTable: "AL_OrganizationUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AbpOrganizationUnitRoles_AL_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AL_Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AbpRoleClaims_AL_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AL_Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "AL_TenantConnectionStrings",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_TenantConnectionStrings", x => new { x.TenantId, x.Name });
                    table.ForeignKey(
                        name: "FK_AL_TenantConnectionStrings_AL_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "AL_Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AbpUserClaims_AL_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "AL_Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AbpUserLogins_AL_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "AL_Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AbpUserOrganizationUnits_AL_OrganizationUnits_OrganizationUnitId",
                        column: x => x.OrganizationUnitId,
                        principalTable: "AL_OrganizationUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AbpUserOrganizationUnits_AL_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "AL_Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AbpUserRoles_AL_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AL_Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AbpUserRoles_AL_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "AL_Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AbpUserTokens_AL_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "AL_Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_Attachments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AL_Attachments_AL_Lookups_AttachmentTypeId",
                        column: x => x.AttachmentTypeId,
                        principalTable: "AL_Lookups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AL_Attachments_AL_Lookups_ModuleTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewCol = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_Configs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AL_Configs_AL_Lookups_TypeId",
                        column: x => x.TypeId,
                        principalTable: "AL_Lookups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_Notifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AL_Notifications_AL_Lookups_TypeId",
                        column: x => x.TypeId,
                        principalTable: "AL_Lookups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "AL_NotificationsTemplates",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AL_NotificationsTemplates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AL_NotificationsTemplates_AL_Lookups_EventId",
                        column: x => x.EventId,
                        principalTable: "AL_Lookups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AL_Attachments_AttachmentTypeId",
                table: "AL_Attachments",
                column: "AttachmentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_AL_Attachments_ModuleTypeId",
                table: "AL_Attachments",
                column: "ModuleTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_AL_Configs_TypeId",
                table: "AL_Configs",
                column: "TypeId");

            migrationBuilder.CreateIndex(
                name: "IX_AL_LinkUsers_SourceUserId_SourceTenantId_TargetUserId_TargetTenantId",
                table: "AL_LinkUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AL_Lookups_LookupTypeId",
                table: "AL_Lookups",
                column: "LookupTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_AL_Lookups_Parent",
                table: "AL_Lookups",
                column: "Parent");

            migrationBuilder.CreateIndex(
                name: "IX_AL_LookupTypes_LookupTypeNumber",
                table: "AL_LookupTypes",
                column: "LookupTypeNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AL_Notifications_TypeId",
                table: "AL_Notifications",
                column: "TypeId");

            migrationBuilder.CreateIndex(
                name: "IX_AL_NotificationsTemplates_EventId",
                table: "AL_NotificationsTemplates",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_AL_OrganizationUnits_Code",
                table: "AL_OrganizationUnits",
                column: "Code");

            migrationBuilder.CreateIndex(
                name: "IX_AL_OrganizationUnits_ParentId",
                table: "AL_OrganizationUnits",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_AL_Roles_NormalizedName",
                table: "AL_Roles",
                column: "NormalizedName");

            migrationBuilder.CreateIndex(
                name: "IX_AL_SecurityLogs_TenantId_Action",
                table: "AL_SecurityLogs",
                columns: new[] { "TenantId", "Action" });

            migrationBuilder.CreateIndex(
                name: "IX_AL_SecurityLogs_TenantId_ApplicationName",
                table: "AL_SecurityLogs",
                columns: new[] { "TenantId", "ApplicationName" });

            migrationBuilder.CreateIndex(
                name: "IX_AL_SecurityLogs_TenantId_Identity",
                table: "AL_SecurityLogs",
                columns: new[] { "TenantId", "Identity" });

            migrationBuilder.CreateIndex(
                name: "IX_AL_SecurityLogs_TenantId_UserId",
                table: "AL_SecurityLogs",
                columns: new[] { "TenantId", "UserId" });

            migrationBuilder.CreateIndex(
                name: "IX_AL_Tenants_Name",
                table: "AL_Tenants",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_AL_Users_Email",
                table: "AL_Users",
                column: "Email");

            migrationBuilder.CreateIndex(
                name: "IX_AL_Users_NormalizedEmail",
                table: "AL_Users",
                column: "NormalizedEmail");

            migrationBuilder.CreateIndex(
                name: "IX_AL_Users_NormalizedUserName",
                table: "AL_Users",
                column: "NormalizedUserName");

            migrationBuilder.CreateIndex(
                name: "IX_AL_Users_UserName",
                table: "AL_Users",
                column: "UserName");
