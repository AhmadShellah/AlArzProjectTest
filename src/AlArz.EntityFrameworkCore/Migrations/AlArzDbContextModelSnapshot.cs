...
{
    [DbContext(typeof(AlArzDbContext))]
    partial class AlArzDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlArz.Entity.CustomLog", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AL_CustomLogs", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entity.Attachment", b =>
                {
                    ...
                    b.ToTable("AL_Attachments", (string)null);
                });

            modelBuilder.Entity("Domain.Entity.BlockedUserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ToeknId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.ToTable("AL_BlockedUserTokens", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entity.Config", b =>
                {
                    ...
                    b.ToTable("AL_Configs", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entity.Lookup", b =>
                {
                    ...
                    b.ToTable("AL_Lookups", (string)null);
                });

            modelBuilder.Entity("Domain.Entity.LookupType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("LookupTypeNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LookupTypeNumber"));
                    ...
                    b.HasIndex("LookupTypeNumber")
                        .IsUnique();

                    b.ToTable("AL_LookupTypes", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entity.Notification", b =>
                {
                    ...
                    b.ToTable("AL_Notifications", (string)null);
                });

            modelBuilder.Entity("Domain.Entity.NotificationTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AL_NotificationsTemplates", (string)null);
                });

            modelBuilder.Entity("Domain.Entity.RegisterFireBase", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AL_RegisterFireBases", (string)null);
                });
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityClaimType", b =>
                {
                    ...
                    b.ToTable("AL_ClaimTypes", (string)null);
                });
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityLinkUser", b =>
                {
                    ...
                    b.ToTable("AL_LinkUsers", (string)null);
                });
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityRole", b =>
                {
                    ...
                    b.ToTable("AL_Roles", (string)null);
                });
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentitySecurityLog", b =>
                {
                    ...
                    b.ToTable("AL_SecurityLogs", (string)null);
                });
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityUserDelegation", b =>
                {
                    ...
                    b.ToTable("AL_UserDelegations", (string)null);
                });
            ...
            modelBuilder.Entity("Volo.Abp.Identity.OrganizationUnit", b =>
                {
                    ...
                    b.ToTable("AL_OrganizationUnits", (string)null);
                });
            ...
            modelBuilder.Entity("Volo.Abp.TenantManagement.Tenant", b =>
                {
                    ...
                    b.ToTable("AL_Tenants", (string)null);
                });
            ...
            modelBuilder.Entity("Volo.Abp.TenantManagement.TenantConnectionString", b =>
                {
                    ...
                    b.ToTable("AL_TenantConnectionStrings", (string)null);
                });

            modelBuilder.Entity("Domain.Entity.Attachment", b =>
                {
                    b.HasOne("Domain.Entity.Lookup", "AttachmentType")
                        .WithMany()
                        .HasForeignKey("AttachmentTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entity.Lookup", "ModuleType")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entity.Config", b =>
                {
                    b.HasOne("Domain.Entity.Lookup", "Lookup")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entity.Lookup", b =>
                {
                    b.HasOne("Domain.Entity.LookupType", "LookupType")
                        .WithMany()
                        .HasForeignKey("LookupTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entity.Lookup", "ParentLookup")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entity.Notification", b =>
                {
                    b.HasOne("Domain.Entity.Lookup", "Type")
                        .WithMany()
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entity.NotificationTemplate", b =>
                {
                    b.HasOne("Domain.Entity.Lookup", "Event")
                        .WithMany()
